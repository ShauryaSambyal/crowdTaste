    ...
    <>
        <div className='text-center py-20'>
            ...
            <form action="" className='px-6'>
                ...
                <button onClick={onclick} className='mx-4 px-8 py-3 text-blue-600 border-2 border-blue-600 rounded-4xl my-3 hover:bg-blue-600 hover:text-white duration-150'>Search</button>

                <div className="scroll-hide mt-3 py-2 px-10 flex items-center sm:justify-center gap-2 overflow-x-auto overflow-y-hidden ">
                    <input type="text" placeholder='Location' className='bg-white rounded-4xl py-2 text-center hover:cursor-pointer hover:border-2 hover:border-blue-600' />
